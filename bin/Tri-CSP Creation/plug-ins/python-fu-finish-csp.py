    ...
    if not selectionExists:
        ...
        if not pdb.gimp_drawable_is_indexed(initialComposite):
            ...
            if saveRef == True:
                ...
                addBackground( RGBA_IMAGE, 50, highResMultiplier )
            ...
            if saveWithPalette:
                ...
                addBackground( 5, 100, highResMultiplier ) # Image type 5 = INDEXEDA (GIMP doesn't actually recognize the latter form)
